...
const Header = () => {
  ...
  return (
    <header className="w-screen fixed top-0 backdrop-blur-sm bg-black/10 z-50">
      ...
      <div className="text-white font-bold text-xl md:text-2xl cursor-pointer" onClick={()=>{navigate("/"); console.log("Header")}}>
      ...
      <button className="hidden md:block bg-[#FCA95D] text-black py-2 px-6 rounded-lg hover:bg-white transition-all duration-300" onClick={()=>navigate("/contact-us")}>
        Contact Us
      </button>
