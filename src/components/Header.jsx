const Header = () => {
  return (
    <header className="w-screen fixed top-0 backdrop-blur-sm bg-black/10 z-50">
      <div className="flex justify-between items-center md:px-12 px-6 max-w-screen-2xl w-full py-4 mx-auto">
        ...
        <nav className="hidden md:block border border-white/20 rounded-md p-3">
          <ul className="flex justify-around text-white">
            <li className="py-2 px-6 hover:text-black hover:bg-white transition-all duration-300 rounded-md cursor-pointer">
              Home
            </li>
            <li className="py-2 px-6 hover:text-black hover:bg-white transition-all duration-300 rounded-md cursor-pointer">
              About
